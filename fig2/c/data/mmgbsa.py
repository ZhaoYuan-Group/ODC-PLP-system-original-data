...
class mmgbsa(object):
    def __init__(self):
        ...
        # delTo()和decEn()
        self.path = "C:/Users/86175/Desktop/gbsa"
    ...
    def decEn(self):    
        ...
        dfall.to_csv(os.path.join(self.path,"decEn_all.csv"))
    ...
    def TolBar(self):  
            ...
            colhline,colbar,colhot="grey",'grey','#F21B42',
            ...
            # ax.axis([x_min-30,x_max+30,y_min-1,y_max])
            ax.axis([x_min - 30, x_max + 30, -20, 2])
